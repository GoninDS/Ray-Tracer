...
def test_lighting_with_pattern():
	...
	sphere.material.pattern = Pattern.striped_pattern(Color(1, 1, 1), Color(0, 0, 0))
...
def test_stripes_with_transformed_object():
	...
	sphere.material.pattern = Pattern.striped_pattern(Color.white(), Color.black())

	color = sphere.stripe_at(Tuple.point(1.5, 0, 0))
...
def test_stripes_with_object_and_pattern_transformation():
	...
	color = sphere.stripe_at(Tuple.point(2.5, 0, 0))
	assert color == Color.white()