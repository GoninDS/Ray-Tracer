...
class Cylinder(Shape):
  ...
  # Method to get the normal of the cylinder at a specific point
  ...
  # Method to intersect a cylinder with a ray
  def local_intersect(self, local_ray):
    ...
    # (Therefore intersects the inside of the cylinder)
    if abs(a) > common.EPSILON:
      # Calculate b and c
  ...
  # a radius of 1 (radius of the cylinder) from the y axis
  @staticmethod
  def check_cap(ray, t):
